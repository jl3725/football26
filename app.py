...
# moved to src/ui/player.py: db_player_card_html
# ── Star Players — 팀 내 ss_rating 상위 N명 ───────────────────────────────────
# pos_chip_color moved to src/ui/common.py


# moved to src/ui/pitch.py: team_star_players, star_card_html, squad_depth_html(+_SLOT_BUCKET)
